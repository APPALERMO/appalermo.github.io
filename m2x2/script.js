...
function calcX(y = Array,t = Array, delta) {
    ...
    r2 = y2 * t1
    r = (r1) - (r2)
    return [`${r}/(${frazioneGen(delta[0])})`, r/delta[0]]
...
function start() {
    ...
    risultati.innerHTML = `<b>Δ = </b>${cDelta[0]} | ${frazioneGen(cDelta[0])} ≠ 0 <br><b>Δx =</b> ${valX[0]} | (${valX[1]} | ${frazioneGen(valX[1])}) <br><b>Δy = </b>${valY[0]} | (${valY[1]} | ${frazioneGen(valY[1])})`
