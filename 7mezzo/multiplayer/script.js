...
const server = new WebSocket("ws:192.168.0.181:8080/")
...
window.onload = (event) => {
    if(screen.width <= 750){
        ...
        punteggioG.style.top = "83%"
        punteggioG.style.left = "82%"
...
function daiCartaG(){
    ...
    if(type !== 0){
        if(r === 0.5) figliaDivCarta.innerHTML = `<img src="https://demo.giocaonline.casino/assets/svg/carte/napoletane/${type}0.svg" height=180 width=120>`
        else figliaDivCarta.innerHTML = `<img src="https://demo.giocaonline.casino/assets/svg/carte/napoletane/${type}${r}.svg" height=180 width=120>`
    }else{
        if(r === 0.5) figliaDivCarta.innerHTML = `<img src="https://demo.giocaonline.casino/assets/svg/carte/napoletane/10.svg" height=180 width=120>`
        else figliaDivCarta.innerHTML = `<img src="https://demo.giocaonline.casino/assets/svg/carte/napoletane/${r}.svg" height=180 width=120>`
    }
    ...
    server.send(`Il GIOCATORE ha preso la carta: ${r}`)
...
function daiCartaP(){
    ...
    server.send(`Il pc ha preso la carta: ${r}`)
